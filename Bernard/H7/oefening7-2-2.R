...
data = survey
data1 = data$W.Hnd #Vermoedelijke onafhankelijke variabele
data2= data$Fold #Vermoedelijke afhankelijke variabele
...
# =========================================== Mozaik plot ======================================================
plot(table(data1,data2), main="Writing hand ~ Folding hand", xlab = "Writing hand", ylab = "Top hand when folding")
barplot(table(data1,data2), main="Writing hand ~ Folding hand", xlab = "Folding", col=c("red","blue"))
legend(1.2, 95, legend=c("Left hand writing", "Right hand writing"), fill = c("red","blue"))
